...
public class VerneuilBlocks {
	...
	public static final DeferredBlock<Block> DRAINED_BLOCK = BLOCKS.registerBlock("drained_block", Block::new);

	public static final DeferredBlock<GeodeBlockEntity.GeodeBlock> GEODE = BLOCKS.registerBlock("geode", GeodeBlockEntity.GeodeBlock::new);
	...
	public static final Supplier<BlockEntityType<GeodeBlockEntity>> GEODE_ENTITY = BLOCK_ENTITY_TYPES.register("my_block_entity",
