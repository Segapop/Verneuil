...
public class QuartzModel extends AbstractGemModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(16, 35).addBox(-3.25F, -1.75F, -2.25F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(-6.0F, 2.0F, 0.0F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(0, 35).addBox(-0.75F, -1.75F, -2.25F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(6.0F, 2.0F, 0.0F));

		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(48, 35).addBox(-4.5F, -0.25F, -2.25F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 13.0F, 0.0F));
		...
		PartDefinition jacket = body.addOrReplaceChild("jacket", CubeListBuilder.create().texOffs(32, 16).addBox(-4.0F, -6.0F, -3.0F, 10.0F, 13.0F, 6.0F, new CubeDeformation(0.25F)), PartPose.offset(-1.0F, 0.0F, 0.0F));
	...
	public void setupAnim(GemRenderState renderState) {
		...
		if (renderState.rightArmPose == ArmPose.CROSSBOW_CHARGE) {
			AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, renderState.maxCrossbowChargeDuration, renderState.ticksUsingItem, renderState.mainArm == HumanoidArm.RIGHT);
		}
	...
	public static ArmorModelSet<MeshDefinition> createArmorMeshSet(Function<CubeDeformation, MeshDefinition> meshCreator, CubeDeformation innerCubeDeformation, CubeDeformation outerCubeDeformation) {
