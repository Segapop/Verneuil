...
public class VerneuilLayerDefinitions {
	...
	public static final ArmorModelSet<LayerDefinition> QUARTZ_ARMOR_LAYER = QuartzModel.createArmorMeshSet(INNER_ARMOR_DEFORMATION, OUTER_ARMOR_DEFORMATION).map(p_432244_ -> LayerDefinition.create(p_432244_, 64, 32));
