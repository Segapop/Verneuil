...
public class VerneuilItems {
	...
	public static final DeferredItem<GemItem> QUARTZ_GEM_AMETHYST = ITEMS.registerItem("amethyst_gem", item -> gemItem(item, VerneuilEntities.QUARTZ.get(), "amethyst"));

	public static final DeferredItem<GemItem> QUARTZ_GEM_RED_STRIPED_JASPER = ITEMS.registerItem("red_striped_jasper_gem", item -> gemItem(item, VerneuilEntities.QUARTZ.get(), "red_striped_jasper"));
