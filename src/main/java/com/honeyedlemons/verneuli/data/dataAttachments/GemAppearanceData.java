...
public class GemAppearanceData {
	...
	public static final Codec<GemAppearanceData> CODEC = RecordCodecBuilder.create(instance -> instance.group(Codec.unboundedMap(Codec.STRING, Codec.STRING).fieldOf("layer_data").forGetter(GemAppearanceData::getLayerData), Codec.unboundedMap(Codec.STRING, Codec.INT).fieldOf("color_data").forGetter(GemAppearanceData::getColorData)).apply(instance, GemAppearanceData::new));

	public static final StreamCodec<RegistryFriendlyByteBuf, GemAppearanceData> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.map(HashMap::new, ByteBufCodecs.STRING_UTF8, ByteBufCodecs.STRING_UTF8), GemAppearanceData::getLayerData, ByteBufCodecs.map(HashMap::new, ByteBufCodecs.STRING_UTF8, ByteBufCodecs.INT), GemAppearanceData::getColorData, GemAppearanceData::new);
